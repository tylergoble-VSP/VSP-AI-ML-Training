...
| `MOD-1` ML Literacy | [`module-1-ml-literacy.md`](module-1-ml-literacy.md) | 1–2 | ~8.5 h | ML (~5% of program) | `ASM-1` quiz + mock pre-sales |
...
| `GAP-3` | Cloud provider landscape lesson (Vertex, Bedrock, Azure AI Foundry) | MOD-3 | P0 |
...
| `GAP-8` | MNIST hands-on adapted for non-ML engineers (guided fill-in notebook) | MOD-1 | P1 |
